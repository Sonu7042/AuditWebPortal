...
import { Info, FileText, MessageSquare, HelpCircle, Check } from "lucide-react";
import { Link } from "react-router-dom";
import { AppContext } from "../../context/AppContext";

export default function CompanyReportView({ reportSections }) {
  const { visitedSections, setVisitedSections } = useContext(AppContext);
  ...
  {reportSections.map((sec, i) => {
    ...
    // 🔥 dynamic check
    const isVisited = visitedSections?.includes(sec.link);
